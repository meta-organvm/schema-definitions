...
**Org:** `meta-organvm` | **Repo:** `schema-definitions`

### Edges
- **Produces** → `ORGAN-IV, META-ORGANVM`: schema

### Siblings in Meta
`.github`, `organvm-corpvs-testamentvm`, `alchemia-ingestvm`, `organvm-engine`, `system-dashboard`, `organvm-mcp-server`, `praxis-perpetua`, `stakeholder-portal`, `materia-collider`, `organvm-ontologia`, `vigiles-aeternae--agon-cosmogonicum`, `cvrsvs-honorvm`
...
Run: `organvm ecosystem show schema-definitions` | `organvm ecosystem validate --organ META`
...
Convergences: 20 | Run: `organvm network map --repo schema-definitions` | `organvm network suggest`


## Entity Identity (Ontologia)

**UID:** `ent_repo_01KKKX3RVR2QZ8P5G4VBA3CD4Z` | **Matched by:** primary_name

Resolve: `organvm ontologia resolve schema-definitions` | History: `organvm ontologia history ent_repo_01KKKX3RVR2QZ8P5G4VBA3CD4Z`
